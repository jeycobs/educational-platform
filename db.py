...
class Course(Base):
    ...
    __table_args__ = (Index('idx_course_title_search', 'title'), Index('idx_course_category_level', 'category', 'level'), Index('idx_course_tags', 'tags'),)
    def __repr__(self): return f"<Course(id={self.id}, title='{self.title}')>"
...
class Material(Base):
    ...
    def __repr__(self): return f"<Material(id={self.id}, title='{self.title}', type='{self.type}')>"
...
class Activity(Base):
    ...
    __table_args__ = (Index('idx_activity_user_material_action', 'user_id', 'material_id', 'action'),)
    def __repr__(self): return f"<Activity(id={self.id}, user_id={self.user_id}, action='{self.action}')>"